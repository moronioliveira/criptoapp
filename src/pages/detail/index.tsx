...
export function Detail() {
  ...
  useEffect(()=> {
    async function getCoin() {
      try{
       fetch(`https://rest.coincap.io/v3/assets/${cripto}?apiKey=3cae2bc52f893b76662ec1b4899ef6f35dfa02b583f3202955831ec6aac764d2`)
  ...
  return (
    ...
    <section className={styles.content}>
      <img src={`https://assets.coincap.io/assets/icons/${coin?.symbol.toLowerCase()}2@2x.png`} 
      alt="Logo da moeda" 
